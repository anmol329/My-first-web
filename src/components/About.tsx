...
export default function About() {
  return (
    <section id="about" className="py-24 bg-[#1A0000] relative z-10 border-t border-accent-red/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -left-8 w-2/3 aspect-square border-2 border-accent-red z-0 hidden md:block"></div>
            {/* Floating stats card */}
            <div className="absolute -right-8 bottom-12 glass-card p-6 z-20 hidden md:block rounded backdrop-blur-xl">
              <div className="text-4xl font-heading text-accent-red">10+</div>
          ...
          <div>
            ...
            >
              <h4 className="text-accent-red font-bold tracking-widest uppercase text-sm mb-4">About Us</h4>
              ...
              <ul className="space-y-4 mb-10">
                {['Certified Professional Trainers', 'Result-Driven Personalized Plans', 'Premium Hygienic Environment'].map((item, i) => (
                  <li key={i} className="flex items-center text-gray-300">
                    <span className="w-6 h-6 rounded-full bg-accent-red/10 flex items-center justify-center mr-3 shrink-0">
              ...
              <a href="#services" className="inline-flex items-center text-white font-bold uppercase tracking-wider text-sm hover:text-accent-red transition-colors group">
